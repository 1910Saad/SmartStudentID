...
// Create a simplified version of student data for the QR code
const createQRData = (studentData: StudentData) => {
  if (!studentData) return "";
  
  // Create a simplified version without the photo (which is large)
  const qrData = {
    id: studentData.id,
...
const IDCardPreview = forwardRef<HTMLDivElement, IDCardPreviewProps>(
  ({ studentData }, ref) => {
    ...
    // Forward the cardRef to parent component
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex justify-center border-t pt-4 border-gray-200">
                    <div className="h-24 w-24 flex items-center justify-center">
                      {studentData ? (
                        <QRCodeSVG 
                          value={createQRData(studentData)}
                          size={96}
                          level="M"
                        />
                      ) : (
